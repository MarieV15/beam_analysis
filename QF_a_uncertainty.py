...
Enr = Recoil_energy_nr(En, angles[3])
f_scale = ROOT.TFile('/home/mvidal/tunl/analysis/Fe55_beam_energy_scale_2018-11-26.root')
...
#c = ROOT.TCanvas()
#QF_a.Draw()
f_out = ROOT.TFile("scale_uncertainty_qf2_28keVnr.root", "recreate")
QF_a.Write("scale")
f_out.Close()
